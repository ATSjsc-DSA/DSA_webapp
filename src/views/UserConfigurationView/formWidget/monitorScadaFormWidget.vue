<template>
  ...
  <div class="flex flex-column gap-2 mb-3">
    <label for="scadaName" class="font-semibold"> Monitor Scada Name </label>
    <InputText id="scadaName" v-model="data.monitorScadaName" disabled class="flex-auto" autocomplete="off" />
  </div>
