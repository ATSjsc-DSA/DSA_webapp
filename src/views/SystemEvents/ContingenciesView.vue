      ...
      >
        <div class="h-full w-full p-4">
          <div class="py-4 flex justify-content-between align-items-center">
            <span class="text-xl font-semibold"> List Contingencies</span>
...
const getListContingencies = async () => {
  try {
...
const createThis = async () => {
  try {
    await ApiContingencies.createContingencies(formItemCreate.value);
    getListContingencies();
    visible.value = false;
